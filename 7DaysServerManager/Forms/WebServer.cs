...
namespace _7DaysServerManager
{
    public partial class Server_Panel_Form : Form
    {
        ...
        private string GenerateContent(string page)
        {
            ...
            {
                if(page.Contains((string)Registry.GetValue(@"HKEY_CURRENT_USER\Software\7DSM\" + profile_name, "android_access_key", null)))
                {
                    ...
                    {
                        rstr += "Players: " + Online_Player_List.Items.Count + "/" + ConfigProperty_ServerMaxPlayerCount.Value;
                    });
            ...
            else if ((string)Registry.GetValue(@"HKEY_CURRENT_USER\Software\7DSM\" + profile_name, "enable_website", null) == "1")
            {
                ...
                Online_Player_List.Invoke((MethodInvoker)delegate
                {
                    ...
                    max_pl_cnt = Convert.ToString(ConfigProperty_ServerMaxPlayerCount.Value);
                ...
                if ((string)Registry.GetValue(@"HKEY_CURRENT_USER\Software\7DSM\" + profile_name, "hide_footer", null) != "1")
